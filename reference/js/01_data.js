...
{ id:'nanjing', title:'南京保卫战 1937', sub:'金陵危城 · 浴血坚守', f:['kmt','jp'], theme:'ruin',
terr:'urban', layout:'city', mode:'assault', atk:1, modeName:'攻防·日军进攻',
flags:[{id:'A',x:72,z:-10,r:13},{id:'B',x:28,z:20,r:13},{id:'C',x:-18,z:-14,r:14},{id:'D',x:-68,z:8,r:13}], bases:[{x:-142,z:0},{x:142,z:0}], sineRoad:false,
roads:[[142,0,72,-10],[72,-10,28,20],[28,20,-18,-14],[-18,-14,-68,8],[-68,8,-142,0]], trench:[[52,8,34,16],[4,-6,-14,4],[-46,-10,-62,0]] },
{ id:'taierzhuang', title:'台儿庄战役 1938', sub:'运河决战 · 正面反攻', f:['kmt','jp'], theme:'china',
terr:'urban', layout:'city', mode:'assault', atk:0, modeName:'攻防·国军反攻',
flags:[{id:'A',x:-72,z:12,r:13},{id:'B',x:-28,z:-20,r:13},{id:'C',x:18,z:16,r:14},{id:'D',x:68,z:-8,r:13}], bases:[{x:-142,z:0},{x:142,z:0}], sineRoad:false,
roads:[[-142,0,-72,12],[-72,12,-28,-20],[-28,-20,18,16],[18,16,68,-8],[68,-8,142,0]], trench:[[-54,-12,-36,-4],[34,10,52,2]] },
{ id:'wuhan', title:'武汉会战 1938', sub:'长江防线 · 举国鏖兵', f:['kmt','jp'], theme:'green',
terr:'rolling', layout:'rural', mode:'conquest', atk:0, modeName:'征服·五点争夺',
flags:[{id:'A',x:-72,z:24,r:13},{id:'B',x:-32,z:-30,r:13},{id:'C',x:2,z:10,r:14},{id:'D',x:38,z:34,r:13},{id:'E',x:74,z:-24,r:13}], bases:[{x:-142,z:0},{x:142,z:0}], sineRoad:true,
roads:[[-72,24,-32,-30],[-32,-30,2,10],[2,10,38,34],[38,34,74,-24]], trench:[[-48,6,-30,-2],[34,-4,54,8]] },
...
{ id:'changsha', title:'长沙会战 1941', sub:'焦土御敌 · 湘北鏖战', f:['kmt','jp'], theme:'green',
terr:'rolling', layout:'rural', mode:'assault', atk:1, modeName:'攻防·日军进攻',
flags:[{id:'A',x:70,z:-20,r:13},{id:'B',x:26,z:28,r:13},{id:'C',x:-20,z:-24,r:14},{id:'D',x:-70,z:16,r:13}], bases:[{x:-142,z:0},{x:142,z:0}], sineRoad:true,
roads:[[142,0,70,-20],[70,-20,26,28],[26,28,-20,-24],[-20,-24,-70,16]], trench:[[48,-4,30,8],[4,12,-14,0],[-46,-6,-62,6]] },
...
trench:[[-32,-36,-12,-44]] },
{ id:'changde', title:'常德会战 1944', sub:'孤城喋血 · 虎贲死守', f:['kmt','jp'], theme:'ruin',
terr:'urban', layout:'city', mode:'assault', atk:1, modeName:'攻防·日军进攻',
flags:[{id:'A',x:70,z:8,r:13},{id:'B',x:24,z:-18,r:13},{id:'C',x:-22,z:20,r:14},{id:'D',x:-72,z:-10,r:13}], bases:[{x:-142,z:0},{x:142,z:0}], sineRoad:false,
roads:[[142,0,70,8],[70,8,24,-18],[24,-18,-22,20],[-22,20,-72,-10]], trench:[[50,24,32,30],[0,-30,-18,-24],[-48,16,-66,8]] },
{ id:'xiangxi', title:'湘西会战 1945', sub:'雪峰山下 · 最后反攻', f:['kmt','jp'], theme:'alpine',
terr:'alpine', layout:'alpine', mode:'assault', atk:0, modeName:'攻防·国军反攻',
flags:[{id:'A',x:-68,z:18,r:13},{id:'B',x:-22,z:-26,r:13},{id:'C',x:24,z:24,r:14},{id:'D',x:70,z:-14,r:13}], bases:[{x:-142,z:0},{x:142,z:0}], sineRoad:false,
roads:[[-142,0,-68,18],[-68,18,-22,-26],[-22,-26,24,24],[24,24,70,-14],[70,-14,142,0]], trench:[[-52,-6,-34,4],[2,10,18,2],[42,-8,58,4]] },
];
let CAMPAIGN_IDX=clamp(parseInt(localStorage.getItem('bf1937_campaign')||'0')||0,0,CAMPAIGNS.length-1);
...
const DEPOTS=[];
// 战役天气: 雨/雪/阴天/雷暴
const WEATHER={songhu:'rain',nanjing:'overcast',taierzhuang:'overcast',wuhan:'rain',baituan:'clear',changsha:'storm',burma:'storm',changde:'overcast',xiangxi:'rain'}[CAMPAIGN.id]||'clear';
// 河流 (进入地形生成)
const RIVER={
